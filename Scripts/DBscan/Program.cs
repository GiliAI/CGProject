...
namespace Resources.Scripts.DBscan
{
    class Program
    {
        public HashSet<Record[]> Dbscan()
        {
           ...
           {
               Vector3 iIdex =
                   exchangeAxis.UnityPos_to_modelIndex(new Vector3(testPoint.posX, testPoint.posY, testPoint.posZ));
               testPointsIndex.Add(new Record(iIdex,new Vector3(testPoint.rotX,testPoint.rotY,testPoint.rotZ)));
           }
