...
namespace Resources.Scripts.DBscan
{
    class ScanProgram
    {
        public HashSet<Record[]> Dbscan(out List<Cluster>clusterDes,List<Record> testPoints)
        {
           ...
           //List<Record> testPoints = Launcher.instance.history.GetRecords();
            ...
            //    }
            //}
            //testPoints = Launcher.instance.history.getAllRecord();
            ...
            */
            ...
            dbs.ComputeClusterDbscan(allPoints: featureData, epsilon:10, minPts: 10, clusters: out clusters, ref clusterIds);
